...
public class UploadServiceImpl implements UploadService {
    ...
    public String uploadImage(MultipartFile file) {
        ...
        try {
            ...
            // 保存到服务器
//            file.transferTo(new File("G:\\study\\leyou\\image\\" + originalFilename));

            //调用客户端保存
            String ex = StringUtils.substringAfterLast(originalFilename, ".");
            StorePath storePath = this.fastFileStorageClient.uploadFile(file.getInputStream(), file.getSize(), ex, null);
            // 生成url地址，返回
